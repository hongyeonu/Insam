...
public class SVT_Body_NormalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_body_normal_svt);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 정답
                String correctAnswer = "원우"; // 원하는 정답을 입력하세요.
                ...
                if (userAnswer.equalsIgnoreCase(correctAnswer)) {
                    ...
                    Toast.makeText(SVT_Body_NormalActivity.this, "정답입니다!", Toast.LENGTH_SHORT).show();
                } else {
                    // 오답인 경우
                    // 원하는 처리를 여기에 추가하세요.
                    // 예를 들어, 메시지를 표시할 수 있습니다.
                    Toast.makeText(SVT_Body_NormalActivity.this, "틀렸습니다. 다시 시도하세요.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
